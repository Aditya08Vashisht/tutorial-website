...
const FrameComponent1 = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-col items-center justify-start max-w-full text-center text-17xl text-white font-satoshi-variable mq450:gap-[25px] mq950:gap-[50px] ${className}`}
    >
